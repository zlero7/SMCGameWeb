...
function AdminLayout() {
  ...
  return (
    <div className="flex h-screen bg-[#f0f2f8] overflow-hidden">
      ...
      {/* 사이드바 */}
      <aside
        className={`${sidebarOpen ? 'w-64' : 'w-16'} bg-[#1c2438] flex flex-col transition-all duration-300 shrink-0`}
      >
        {/* 로고 영역 */}
              ...
              {group.items.map(item => {
                ...
                return (
                  <Link
                    ...
                    className={`flex items-center gap-3 px-3 py-2.5 rounded-lg mb-0.5 no-underline transition-all group relative
                      ${active
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between shrink-0">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              to="/"
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm text-gray-600 hover:bg-gray-100 no-underline transition-colors"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
              </svg>
